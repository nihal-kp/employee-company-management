...
<div class="subheader py-2 py-lg-4  subheader-solid " id="kt_subheader">
    <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
            ...
            <span class="text-muted font-weight-bold mr-4">Employees</span>
							...
							<div class="container">
								...
								<div class="card card-custom">
									...
									<div class="card-body">
    										...
    										<table class="table table-responsive  table-separate table-head-custom table-checkable" id="employee-table">
    											<thead>
    												<tr>
				                                      <th>Name</th>
				                                      <th>Email</th>
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                     <button type="button" class="btn btn-danger btn_delete_employee "><i class="flaticon-delete-1"></i>Delete</button>
...
<script type="text/javascript">
   ...
   $(function() {
     ...
     $('table').on('click','.employee-delete', function(e){

        var option_href=$(this).data('href');

            $('.btn_delete_employee').off().click(function() {
